package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_472 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_91 = parseIdle;
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_128,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_128))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_128,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && var_91 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_128,"EOF"));
            }
         }
      }
      ...
      {
         if(var_472.parse(param1))
         {
            var_46.push(var_472);
            if(false)
            {
               var_124["null"] = var_472;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1388,var_472));
            var_472 = null;
            if(var_91 != parseIdle)
            {
               var_91 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_124 != null && param1 < var_46.length)
         {
