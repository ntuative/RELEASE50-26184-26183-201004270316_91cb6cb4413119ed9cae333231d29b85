package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1155:int = 13421772;
      
      private static const const_789:int = 16777215;
      
      public static const const_1323:int = 10066329;
      
      private static const const_791:int = 13421772;
      
      public static const const_1168:int = 16777215;
      
      private static const const_1444:int = 0;
      
      public static const const_1332:int = 16777215;
      
      private static const const_788:int = 10066329;
      
      private static const const_790:int = 10066329;
      
      public static const const_1269:int = 13421772;
      ...
      private var var_1099:uint = 16777215;
      ...
      private const const_1661:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1020);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_963);
         var _loc7_:int = 0;
         while(_loc7_ < var_78.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_145)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1168;
               }
               else
               {
                  _loc13_.color = const_1155;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_227,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_1370)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_227,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_227 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_446.maskCount)
         {
            _loc6_ = var_446.getMaskType(_loc5_);
            _loc7_ = var_446.getMaskLocation(_loc5_);
            _loc8_ = var_446.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_107.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_227 || _loc3_.type == RoomPlane.const_190 && _loc8_ == RoomPlaneBitmapMaskData.const_200)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1551;
                        if(var_78.getPlaneType(_loc9_) == RoomPlaneData.const_145)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1155)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_980 || _loc9_.y != var_1670 || _loc9_.z != var_1666 || param1.scale != var_1668))
            {
               var_980 = _loc9_.x;
               var_1670 = _loc9_.y;
               var_1666 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_948);
            if(_loc10_ != var_2210)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_511));
            if(_loc11_ != var_1099)
            {
               var_1099 = _loc11_;
               var_2212 = var_1099 & 255;
               var_2211 = var_1099 >> 8 & 255;
               var_2213 = var_1099 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1895 + const_1661 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1895 = _loc7_;
         if(var_165 != _loc6_.getUpdateID())
         {
            ...
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_727);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_704);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2209 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_907));
            var_165 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_445.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_445[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_190)
            {
               if(var_2209)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2212 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2211 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2213 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_227 && param2 != null)
               {
                  _loc5_.id = param2;
               }
