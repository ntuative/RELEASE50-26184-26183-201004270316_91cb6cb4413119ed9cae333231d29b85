package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1078:LayoutRasterizerData = null;
      ...
      {
         var_520 = true;
         var _loc3_:int = var_359.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_359.push(param1);
            var_521.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1076 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_736);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1303 = RoomObjectVariableEnum.const_932;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1303 = RoomObjectVariableEnum.const_861;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1076 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1076 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1076 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1076 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1303);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_451;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2133);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_736)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1078 = var_40.getValue(var_736);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_736);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1078.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_359.indexOf(_loc10_) >= 0 && var_520)
            {
               param1 = var_359.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_883.getAsset(var_521[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
