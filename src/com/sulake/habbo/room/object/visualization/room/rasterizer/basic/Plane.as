package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_749:PlaneVisualization = null;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_321.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_749 = var_321.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_749 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_321 != null)
         {
            ...
            {
               _loc1_ = var_321.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
