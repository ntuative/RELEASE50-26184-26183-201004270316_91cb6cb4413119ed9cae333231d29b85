package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1459:int = 16777216;
      ...
      private var var_1472:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1472 * param2);
      }
      ...
      {
         var _loc1_:int = var_2367 * var_1200 + var_2366;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
