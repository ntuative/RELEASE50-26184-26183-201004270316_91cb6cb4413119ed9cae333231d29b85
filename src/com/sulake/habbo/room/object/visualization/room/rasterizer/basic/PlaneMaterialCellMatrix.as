package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1316:int = const_295;
      ...
      public static const const_584:int = 6;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_349[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1501 == const_103)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_350);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_350,var_24.width,var_350);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_24 != null)
            {
               if(var_24.width == param2 && var_24.height == param3 && Vector3d.isEqual(var_595,param4))
               {
                  if(param1 != null)
                  {
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_349.length)
         {
            _loc11_ = var_349[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_595 != null)
         {
            var_595.assign(new Vector3d());
         }
         var_350 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_349.length)
         {
            _loc2_ = var_349[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_349.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_349[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_349[param1] = _loc5_;
