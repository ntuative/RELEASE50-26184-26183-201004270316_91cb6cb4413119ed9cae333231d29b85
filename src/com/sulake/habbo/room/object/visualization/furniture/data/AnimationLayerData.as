package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_191[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1424)
         {
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_191.length)
            {
               _loc2_ = var_191[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_191[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = var_191[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
