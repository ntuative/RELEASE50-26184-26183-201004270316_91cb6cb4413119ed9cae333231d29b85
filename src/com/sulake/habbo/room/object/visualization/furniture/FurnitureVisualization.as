package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_1185:Boolean = true;
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = method_7(_loc5_,var_2288,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_1822 != param1 || var_1823 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1820 != param1 || var_1821 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2288 = _loc3_.getNumber(RoomObjectVariableEnum.const_232);
            ...
            var_1574 = _loc3_.getString(RoomObjectVariableEnum.const_324);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_294 != _loc3_.getUpdateID() || param1 != var_214 || param2 != var_2282)
         {
      ...
      protected function method_7(param1:int, param2:int, param3:int) : int
      {
         if(false)
         {
