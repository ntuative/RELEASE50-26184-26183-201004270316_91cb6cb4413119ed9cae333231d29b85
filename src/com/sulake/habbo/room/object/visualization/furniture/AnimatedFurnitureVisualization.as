package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_323.length)
         {
            _loc3_ = var_323[param1] as AnimationFrame;
            if(_loc3_ != null)
            {
               return _loc3_.id;
            }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_505 == 0)
         {
            var_505 = _animationData.getStartFrame(var_1090,param1);
         }
         var_505 += 1;
         ...
         {
            _loc5_ = null;
            if(_loc4_ < var_323.length)
            {
               _loc5_ = var_323[_loc4_] as AnimationFrame;
            }
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_967)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1090,var_505,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1090,_loc6_,_loc5_.activeSequenceOffset + 1,var_505,param1);
               }
               var_323[_loc4_] = _loc5_;
               if(_loc5_ != null)
               {
                  _loc3_ = true;
               }
