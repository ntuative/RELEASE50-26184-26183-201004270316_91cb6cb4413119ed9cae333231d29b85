   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_689:
                  _loc2_.setString(RoomObjectVariableEnum.const_727,_loc3_.value);
                  break;
               ...
               case RoomObjectRoomUpdateMessage.const_642:
                  _loc2_.setString(RoomObjectVariableEnum.const_704,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_426:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_200)
                  {
                     _loc8_ = "null";
                  }
                  var_446.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_562:
                  _loc7_ = var_446.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_446.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_948,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_907,int(_loc5_.bgOnly));
            var_1138 = _color;
            var_1413 = var_1139;
            var_968 = _loc11_;
            var_1411 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1020,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_511,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1326,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1363,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1223,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_147 || _loc13_ == RoomPlaneData.const_275)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_786)
         {
            ...
            {
               _loc7_ = var_1138 >> 16 & 255;
               _loc8_ = var_1138 >> 8 & 255;
               _loc9_ = var_1138 & 255;
               _loc10_ = var_968 >> 16 & 255;
               _loc11_ = var_968 >> 8 & 255;
               _loc12_ = var_968 & 255;
               _loc13_ = (_loc2_ - var_786) / var_1412;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1413 + (var_1411 - var_1413) * _loc13_;
               _color = _loc3_;
               var_1139 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_511,_loc3_);
         }
      }
   }
}
