package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneData
   {
      ...
      public static const const_995:int = 0;
      ...
      private var var_1644:Vector3d = null;
      ...
      public function RoomPlaneData(param1:int, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Array)
      {
         ...
         {
            var_468 = Vector3d.crossProduct(param3,param4);
            _loc6_ = 0;
            _loc7_ = 0;
            _loc8_ = 0;
            _loc9_ = 0;
            ...
            var_1644 = new Vector3d(_loc6_,_loc7_,_loc8_);
         }
      ...
      public function getSecondaryNormal(param1:int) : IVector3d
      {
         ...
         _loc2_.assign(var_1137[param1] as IVector3d);
         return _loc2_;
      }
