   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(var_161 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_161 = _sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_431,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
         ...
         if(var_161 != null)
         {
            ...
            if(_loc8_ != null)
            {
               _loc9_ = _sessionManager.getGroupBadgeImage(_sessionManager.method_10(_loc2_.id));
               if(_loc9_ != null)
               {
      ...
      private function onGroupDetailsEvents(param1:Event) : void
      {
         ...
         var _loc3_:HabboGroupDetails = _sessionManager.getGroupDetails(var_2265);
         switch(_loc2_.name)
         {
