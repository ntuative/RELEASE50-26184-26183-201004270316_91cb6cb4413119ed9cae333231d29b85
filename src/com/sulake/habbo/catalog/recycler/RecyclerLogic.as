package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_777:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1569)
         {
            case RecyclerStatusMessageEvent.const_1157:
               ...
               break;
            case RecyclerStatusMessageEvent.const_891:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1569 != RecyclerStatusMessageEvent.const_891;
      }
      
      private function get statusActive() : Boolean
      {
         return var_275 != const_777;
      }
      ...
      {
         return active && var_275 == const_355;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_885:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1173:
