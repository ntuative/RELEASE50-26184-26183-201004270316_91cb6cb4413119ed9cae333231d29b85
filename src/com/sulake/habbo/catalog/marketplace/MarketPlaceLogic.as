package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1674:int = 3;
      
      public const const_1623:int = 2;
      ...
      private var var_1794:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1606,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1797 || param1.furniTypeId != var_1796)
         {
            return;
         }
         var_1794 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1623,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1800 = _loc3_.creditsWaiting;
         var_194 = new Map();
      ...
      {
         requestOffers(var_1795,var_1801,var_1793,var_1798);
      }
