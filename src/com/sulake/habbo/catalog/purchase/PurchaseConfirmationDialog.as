package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1445:uint = 4.294967295E9;
      
      private const const_1446:uint = 4.293848814E9;
      
      private var var_922:int;
      
      private const const_1667:uint = 4.291613146E9;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_247.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1446) : uint(const_1445);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_419,var_76,var_1106);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_247.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_287) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc9_:int = !!_loc6_ ? 0 : int(var_634[var_212]);
         _catalog.purchaseProductAsGift(var_419,var_76,var_1106,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_114:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_2241 == _loc3_.text)
               {
                  return;
               }
            ...
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowKeyboardEvent.const_527:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_287 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_287 + 1);
                     break;
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_247.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_287) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_287);
         }
         var_287 = param1;
         if(var_287 < 0)
         {
            var_287 = _loc2_.numListItems - 1;
         }
         if(var_287 >= _loc2_.numListItems)
         {
            var_287 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_287) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_247 == null)
         {
            var_247 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_542 == null)
         {
