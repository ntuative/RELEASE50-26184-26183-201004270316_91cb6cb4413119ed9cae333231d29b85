package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1134:Number = 4285716709;
      ...
      private var var_2350:IWindowContainer;
      ...
      private var var_1593:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1593 == 4294967295)
            {
               var_1593 = _loc1_.color;
            }
            _loc1_.color = const_1134;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1171;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1591) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1592) as IItemListWindow;
         if(var_50 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1244;
            }
         }
      }
