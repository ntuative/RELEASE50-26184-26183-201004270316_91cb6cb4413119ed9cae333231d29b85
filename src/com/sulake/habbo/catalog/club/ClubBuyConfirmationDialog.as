package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               var_27.confirmSelection(var_76,var_419);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc2_:ICoreLocalizationManager = var_27.localization;
         var _loc4_:* = "";
         var _loc5_:int = var_27.getClubType();
         ...
         var _loc7_:IPurse = var_27.getPurse();
