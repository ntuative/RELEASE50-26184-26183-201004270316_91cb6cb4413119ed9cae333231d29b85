package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1076:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      private static const const_1077:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_586.length)
         {
            _loc2_ = String(var_586[param1]).replace("#","0x");
