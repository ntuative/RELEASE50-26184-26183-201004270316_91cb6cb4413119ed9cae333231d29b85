package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1414:String = "ctlg_";
      ...
      private var var_1378:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_897:ICatalogViewer;
      ...
      {
         var _loc2_:String = const_1414 + param1;
      ...
      {
         return _localization.hasLinks(var_940);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1378;
            _loc2_.init();
         }
         var_1378.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1378.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_940);
      }
