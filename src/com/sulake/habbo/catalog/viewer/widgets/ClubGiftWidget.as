package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         var_608.reset();
         _loc2_ = var_27.getOffers();
         if(!_loc2_)
         {
            return;
         }
         var _loc3_:Map = var_27.getGiftData();
         if(!_loc3_)
         {
            return;
         }
      ...
      private function updateInfo() : void
      {
         ...
         if(false)
         {
            ...
            var_27.localization.registerParameter(_loc2_,"amount",var_27.giftsAvailable.toString());
         }
         else if(false)
         {
            _loc2_ = "catalog.club_gift.days_until_next";
            var_27.localization.registerParameter(_loc2_,"days",var_27.daysUntilNextGift.toString());
         }
         else if(false)
         {
         ...
         _loc1_.text = var_27.localization.getKey(_loc2_);
         if(true)
         {
            return;
         }
         ...
         if(_loc5_)
         {
            _loc2_ = var_27.purse.pastClubDays > const_155 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = var_27.purse.pastClubDays % const_155;
            _loc4_ = var_27.purse.pastClubDays / const_155;
            var_27.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_27.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc5_.text = var_27.localization.getKey(_loc2_);
         }
         var _loc6_:ITextWindow = window.findChildByName("past_vip_days") as ITextWindow;
         if(_loc6_)
         {
            _loc2_ = var_27.purse.pastVipDays > const_155 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = var_27.purse.pastVipDays % const_155;
            _loc4_ = var_27.purse.pastVipDays / const_155;
            var_27.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_27.localization.registerParameter(_loc2_,"months",_loc4_.toString());
            _loc6_.text = var_27.localization.getKey(_loc2_);
         }
      }
      ...
      {
         if(!param1 || !param2 || !var_608 || !var_27)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         else
         {
            ...
            if(param2.isVip)
            {
               _loc12_ = _loc11_ - var_27.purse.pastVipDays;
               _loc6_ = "catalog.club_gift.vip_missing";
            }
            else
            {
               _loc12_ = _loc11_ - var_27.purse.pastClubDays;
            ...
            else
            {
               ...
               var_27.localization.registerParameter(_loc6_,"days",_loc13_.toString());
               var_27.localization.registerParameter(_loc6_,"months",_loc14_.toString());
            }
         }
         setText(_loc3_.findChildByName("months_required"),var_27.localization.getKey(_loc6_));
