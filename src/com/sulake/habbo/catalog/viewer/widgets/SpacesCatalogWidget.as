package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1377:String = "default";
      ...
      private var var_1375:String = "1.1";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_263 != null && var_265 != null)
         {
            setRoomImage(var_263,var_265);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_191:
               ...
               if(var_305 >= _activeFloorPatterns.length)
               {
                  var_305 = 0;
               }
               var_264 = 0;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1377);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1377,var_1375,64,this,"window_romantic_wide");
