package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1239:IScrollbarWindow;
      
      protected var var_1318:XML;
      
      private var var_1240:BitmapData;
      
      private var var_1259:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_594 != null)
         {
            var_594.visible = false;
            var_594.destroyGridItems();
         }
         if(var_1239 != null)
         {
            var_1239.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1260.text = "${" + _loc3_.name + "}";
            var_1259.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1260.text = "${" + _loc2_.localizationId + "}";
            var_1259.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_366:
                  _loc4_ = var_1240.clone();
                  if(var_594 != null)
                  {
                     var_594.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_594,var_1239,var_1318);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_198:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_296,AvatarAction.const_520);
                              _loc13_.appendAction(AvatarAction.const_530,_loc6_.productClassId);
      ...
      {
         var_1260 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1259 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1500 = new Point(var_85.x,var_85.y);
         var_594 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1239 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_594 == null)
         {
         ...
         var_1240 = _loc2_.content as BitmapData;
