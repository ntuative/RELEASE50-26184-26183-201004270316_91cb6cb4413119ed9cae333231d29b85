package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1023 != null)
         {
            var_1023.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1024 != null)
         {
            var_1024.removeEventListener(WindowKeyboardEvent.const_149,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1023 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1023 != null)
         {
            var_1023.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1024 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1024 != null)
         {
            var_1024.addEventListener(WindowKeyboardEvent.const_149,windowKeyEventProcessor);
         }
      }
