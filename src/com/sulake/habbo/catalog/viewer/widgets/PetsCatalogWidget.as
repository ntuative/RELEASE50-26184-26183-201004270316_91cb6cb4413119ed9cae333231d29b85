package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_386 >= var_297.length)
         {
            return "";
         }
         var petColor:IPetColor = var_297[var_386] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_554[var_1404] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_386 = param1.index;
         if(var_386 < 0 || var_386 > var_297.length)
         {
            var_386 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_114,onTextWindowEvent);
         var_608 = new Map();
         ...
         events.addEventListener(WidgetEvent.const_1004,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_386 >= 0 && var_386 < var_297.length)
         {
            _loc7_ = var_297[var_386] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_554[var_1404] as IBreed;
         ...
         _loc4_.appendAction(AvatarAction.const_296,AvatarAction.const_515);
