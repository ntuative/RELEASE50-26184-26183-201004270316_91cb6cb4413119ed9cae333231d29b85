package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_671:ISkinContainer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_671 = new SkinContainer(_loc3_.content as XML,assets);
         var_716 = new WindowRenderer(var_671);
         var_232 = new Array(const_354);
         var _loc5_:int = 0;
         while(_loc5_ < const_354)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_716,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_232[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_232[const_1091];
         ...
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1170,_loc6_);
      }
      ...
      {
         var _loc3_:Dictionary = var_425[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_425[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_671.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1386.length > 0)
         {
            WindowContext.var_1386.flush();
         }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1189,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1153,param2.name + ": " + param2.toString());
            }
         }
      }
   }
