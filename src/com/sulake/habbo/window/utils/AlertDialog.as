package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_707:String = "_alert_button_ok";
      
      private static const const_1172:String = "_alert_text_summary";
      
      private static var var_648:uint = 0;
      
      private static const const_764:String = "_alert_button_custom";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_707);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_764);
               _loc8_.dispose();
            }
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_186 != null)
                  {
                     var_186(this,new WindowEvent(WindowEvent.const_172,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_186 != null)
                  {
                     var_186(this,new WindowEvent(WindowEvent.const_685,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!_disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_707:
                  _loc2_ = _window.findChildByName(const_707) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_765:
                  _loc2_ = _window.findChildByName(const_765) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_764:
                  _loc2_ = _window.findChildByName(const_764) as IInteractiveWindow;
            }
         }
