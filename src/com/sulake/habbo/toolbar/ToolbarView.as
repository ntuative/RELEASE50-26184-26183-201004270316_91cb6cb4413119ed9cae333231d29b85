package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1560:Number = 5;
      
      private var var_272:Array;
      
      private var var_140:Number = 50;
      
      private var var_1297:Number = 0;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_207 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_870,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1297 = _loc7_.toolbar.@margin_bottom;
         var_1561 = _loc7_.toolbar.@min_group_margin;
         var_1560 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_272,param1,param2,_window,var_254);
         createGroupsFromXmlList(_loc9_,var_611,param1,param2,var_207,var_254);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_140,var_510,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1561,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1297) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1561,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1297) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_140,var_510);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_140,var_510);
         }
      }
