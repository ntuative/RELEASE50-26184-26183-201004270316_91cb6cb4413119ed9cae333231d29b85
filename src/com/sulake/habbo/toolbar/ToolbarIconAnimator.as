package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_860 = new Array();
         var_34 = param1.id;
         var_1172 = param1.nextState;
         var_1268 = param1.loop;
         if(param1.background != null)
         {
            var_862 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_861.push(new XML());
               var_860.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_860[var_51] = param6.clone();
         }
      ...
      {
         if(var_1268 == true || var_717 == 0)
         {
            if(false)
            {
               ++var_51;
               if(var_51 >= var_861.length)
               {
                  var_51 = 0;
                  ++var_717;
               }
      ...
      {
         return var_861.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1268 == false && var_717 == 1 && var_1172 != var_34;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_862 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_862.width),Math.max(param2.height,var_862.height));
            _loc3_.copyPixels(var_862,var_862.rect,new Point(0,0));
