package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private var var_1004:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_484.push(param2);
         param1.addEventListener(WindowEvent.const_388,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1004.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1004.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_577[_loc3_] = new Array();
            }
            if(var_577[_loc3_].indexOf(param1) < 0)
            {
               var_577[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_760 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_760 || param1.desktop.height - param1.y < const_1061;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_485.length)
         {
            if(var_485[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_577[_loc3_].length)
                  {
                     repositionWindow(var_577[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
