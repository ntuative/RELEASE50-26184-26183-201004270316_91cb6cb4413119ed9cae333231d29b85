package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_318.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_121,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_829,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_166,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_185,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_50,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_410,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_639,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_951,onHideWindowEvent);
         var_34 = true;
