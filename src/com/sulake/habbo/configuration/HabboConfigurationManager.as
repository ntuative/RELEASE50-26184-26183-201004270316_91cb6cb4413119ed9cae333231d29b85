package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_504 = getKey("url_prefix");
         if(var_504 != null && false)
         {
            setKey("client.fatal.error.url",var_504 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1283);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1058[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_504 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_504.replace("http://","");
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_843 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_183));
         if(var_2081)
         {
      ...
      {
         var _loc4_:String = var_1058[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_504);
