package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_783:IHabboHelp = null;
      ...
      private var var_782:IRoomWidgetFactory = null;
      ...
      private var var_2058:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_609,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_722 = _roomEngine.loadRoomResources(var_39.roomResources);
            if(false)
            {
               var_1276 = false;
         ...
         {
            var_1277 = !var_250.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_39.roomId,var_39.roomCategory,var_271[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_609,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_782 = null;
         ...
         if(var_200 && false)
         {
            ...
            var_200.events.removeEventListener(HabboToolbarEvent.const_62,onHabboToolbarEvent);
         }
         var_200 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2058);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_200 != null)
         {
            var_179.toolbarSize = var_200.size;
            var_179.toolbarOrientation = var_200.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_782.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_601:
               ...
               if(var_651 != null && _loc3_ == RoomObjectCategoryEnum.const_39)
               {
                  _loc7_ = var_39.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_317)
                  {
            ...
            case RoomEngineObjectEvent.const_375:
               ...
               break;
            case RoomEngineObjectEvent.const_381:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_663);
            _loc13_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_623);
            _loc14_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_649);
            _loc15_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_559);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_39 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_185,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_381:
               ...
               var_180 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_289,WindowStyle.const_299,WindowParam.const_88) as IToolTipWindow;
      ...
      {
         if(var_722 == null || false)
         {
            return;
         }
         var _loc2_:int = var_722.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_722.splice(_loc2_,1);
         }
         if(false)
         {
            var_1276 = true;
      ...
      {
         if(var_18 != null && var_39 != null && var_1277 && var_1276)
         {
            var_18.startSession(var_39);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_264));
         }
      }
