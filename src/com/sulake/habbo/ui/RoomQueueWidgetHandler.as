package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_428:
               ...
               {
                  case RoomSessionQueueEvent.const_994:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_860) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_860) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1287) + 1;
                  }
               }
               else
               {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_582);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_582:
            ...
            case RoomWidgetRoomQueueMessage.const_709:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_994);
               break;
            case RoomWidgetRoomQueueMessage.const_656:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_211,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_428];
      }
