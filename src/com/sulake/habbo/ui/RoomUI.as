package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_494:IHabboSoundManager;
      
      private var var_1136:IHabboAvatarEditor = null;
      
      private var var_250:IAdManager;
      
      private var var_782:IRoomWidgetFactory;
      ...
      private var var_783:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_967 = RoomDesktop.const_485;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_782;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_494 = param2 as IHabboSoundManager;
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_330:
            ...
            case RoomSessionEvent.const_108:
               if(param1.session != null)
               {
                  ...
                  var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.ZOOM));
                  var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.MEMENU));
                  var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_250.events.addEventListener(AdEvent.const_369,adEventHandler);
            var_250.events.addEventListener(AdEvent.const_469,adEventHandler);
            var_250.events.addEventListener(AdEvent.const_440,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_782 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_782 != null)
         {
            var_782.release(new IIDHabboRoomWidget());
            var_782 = null;
         }
         if(var_11 != null)
         {
         ...
         if(var_494 != null)
         {
            var_494.release(new IIDHabboSoundManager());
            var_494 = null;
         }
         if(var_250 != null)
         {
         ...
         if(var_783 != null)
         {
            var_783.release(new IIDHabboHelp());
            var_783 = null;
         }
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_485)
            {
               var_967 = _loc3_;
            }
            _loc2_.dispose();
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_733:
               ...
               if(_roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_185,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
               ...
               if(var_967 != RoomDesktop.const_485)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_281,var_967);
               }
               if(var_250 != null)
               {
                  var_250.showRoomAd();
            ...
            case RoomEngineEvent.const_588:
               ...
               break;
            case RoomEngineRoomColorEvent.const_738:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_596:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_635:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_522,roomEngineEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_738,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_601,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_381,roomObjectEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_330,roomSessionStateEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionDoorbellEvent.const_125,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_1016,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_954,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_635,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_428,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_112,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_134,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPollEvent.const_132,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_420,roomSessionEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_522)
         {
            if(var_18 != null)
            {
               var_18.roomEngineReady = true;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1136 = param2 as IHabboAvatarEditor;
      }
   }
}
