package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_688,RoomWidgetEcotronBoxOpenMessage.const_676,RoomWidgetEcotronBoxOpenedMessage.const_1237];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_688:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_676:
