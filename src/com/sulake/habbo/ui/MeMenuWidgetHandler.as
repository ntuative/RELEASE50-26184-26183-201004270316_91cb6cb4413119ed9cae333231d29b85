   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_200 + " " + _loc7_);
            if(var_200 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_829,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_200.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_551,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_449,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_551,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_978,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_892,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_449,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_449:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_437));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_650);
         _loc1_.push(RoomWidgetDanceMessage.const_703);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_554);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_597);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_683);
         _loc1_.push(RoomWidgetStopEffectMessage.const_519);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1258);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_965);
         ...
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_698);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_591);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1311);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_594);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_571);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_698:
               ...
               break;
            case RoomWidgetWaveMessage.const_650:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_703:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_554:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_564:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_683:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_933)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_211,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_597:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_900:
                        _catalog.openCatalogPage(CatalogPageName.const_1309,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_959:
                        var_11.toggleInventoryPage(InventoryCategory.const_268);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1350:
                        var_11.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1344:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_519:
            ...
            case RoomWidgetToolbarMessage.const_641:
               ...
               if(var_200)
               {
                  var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_607:
               ...
               if(var_200 && false)
               {
                  var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_410,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_594:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_318,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_571:
