package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_534:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_673,RoomWidgetChatSelectAvatarMessage.const_720];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_673:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_144,_container.roomSession,0,"Version 26184-26183-201004270241");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_720:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_904 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_904);
            }
            if(var_534 == null)
            {
               var_533.x = 0;
               var_533.y = 0;
               var_533.z = 0;
               var_534 = _loc4_.getScreenPoint(var_533);
               var_904 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_533.x = 0;
            var_533.y = 0;
            var_533.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_533);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_534.x || _loc8_.y != var_534.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_534,_loc5_));
