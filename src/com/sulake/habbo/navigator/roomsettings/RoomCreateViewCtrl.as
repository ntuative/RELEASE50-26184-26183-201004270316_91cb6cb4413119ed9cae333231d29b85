package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_885:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_514 = new Timer(100);
         var_514.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      public function dispose() : void
      {
         if(var_514)
         {
            var_514.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_514.reset();
            var_514 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_885.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1300 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1300 = true;
            _loc3_.y = 1;
