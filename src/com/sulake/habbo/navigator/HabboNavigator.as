package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_863:RoomCreateViewCtrl;
      
      private var var_1829:RoomThumbnailRenderer;
      
      private var var_200:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_604:RoomInfoViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_604 = new RoomInfoViewCtrl(this);
         var_863 = new RoomCreateViewCtrl(this);
         var_1829 = new RoomThumbnailRenderer(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_270.startSearch(Tabs.const_199,Tabs.const_339,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_149.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_200 != null)
         {
            var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_991 = new IncomingMessages(this);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_270.startSearch(Tabs.const_265,Tabs.const_234);
         var_389.getTab(Tabs.const_265).tabPageDecorator.tabSelected();
      }
      ...
      public function refreshButton(param1:IWindowContainer, param2:String, param3:Boolean, param4:Function, param5:int, param6:String = null) : void
      {
         ...
         {
            method_3(_loc7_,param6,param4,param5);
            _loc7_.visible = true;
         }
      }
