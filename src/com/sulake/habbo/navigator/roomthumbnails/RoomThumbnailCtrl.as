package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1497,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1496,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1978 = IWindowContainer(find("tile_grid"));
         var_1979 = IWindowContainer(find("now_editing_container"));
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1978;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1979;
