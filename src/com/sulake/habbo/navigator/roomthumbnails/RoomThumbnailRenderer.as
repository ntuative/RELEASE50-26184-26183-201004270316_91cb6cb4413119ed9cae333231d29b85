package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1092:int = -16;
      
      private static const const_775:int = 32;
      
      private static const const_1094:int = 8;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_859 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_859.getImage(ThumbnailEditorModel.const_36,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1092,_loc4_.y + const_1093 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2045[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_859.getImage(ThumbnailEditorModel.const_41,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_859.getImage(ThumbnailEditorModel.const_41,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_859.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_775 / 2);
         return new Point(param1 * const_775 + _loc3_,param2 * const_1094);
      }
