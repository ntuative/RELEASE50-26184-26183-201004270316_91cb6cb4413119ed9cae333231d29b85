package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_818:IAvatarRenderManager;
      ...
      private var var_1590:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_627:ISessionDataManager;
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_374.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_374.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_389.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function method_3(param1:IBitmapWrapperWindow, param2:String, param3:Function, param4:int) : void
      {
         param1.id = param4;
      ...
      {
         var_627 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_374 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_90.addCategory(new FriendCategory(FriendCategory.const_821,getText("friendlist.friends")));
         var_90.addCategory(new FriendCategory(FriendCategory.const_364,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_538)
         {
            var_538 = new Timer(120000);
            var_538.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_538.start();
         }
         getBuddyRequests();
         registerListeners();
         var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_538.stop();
            var_538.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_538 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_818)
         {
            var_818.release(new IIDAvatarRenderManager());
            var_818 = null;
         }
         if(var_913)
         {
            var_913.release(new IIDHabboNotifications());
            var_913 = null;
         }
         if(var_200)
         {
         ...
         if(var_627)
         {
            var_627.release(new IIDSessionDataManager());
            var_627 = null;
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:String = var_149.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1590.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_185,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_374.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_627.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_627.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_374.limit)
         {
            var_374.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_389.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_818.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_374.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_389.findTab(FriendListTab.const_87);
      ...
      public function refreshButton(param1:IWindowContainer, param2:String, param3:Boolean, param4:Function, param5:int) : void
      {
         ...
         {
            method_3(_loc6_,param2,param4,param5);
            _loc6_.visible = true;
         }
      }
      ...
      {
         return var_149.getKey(param1,param1,param2);
      }
