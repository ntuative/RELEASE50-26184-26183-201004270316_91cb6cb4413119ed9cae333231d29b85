package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_748:ITextFieldWindow;
      ...
      {
         var_748 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_748.procedure = onSearchInput;
         var_748.addEventListener(WindowKeyboardEvent.const_149,onSearchStrInput);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:String, param4:String, param5:String, param6:Boolean, param7:Boolean, param8:Boolean, param9:int) : Boolean
      {
         ...
         _friendList.refreshButton(_loc10_,"start_chat",param7,method_9,param9);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_748.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
