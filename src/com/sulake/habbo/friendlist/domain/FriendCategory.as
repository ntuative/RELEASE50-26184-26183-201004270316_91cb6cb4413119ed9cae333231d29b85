package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_243.length / const_335);
      }
      ...
      {
         if(this.var_914 >= this.getPageCount())
         {
            this.var_914 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_914 + 1) * const_335,this.var_243.length);
      }
