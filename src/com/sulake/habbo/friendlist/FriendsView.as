package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1853:IContainerButtonWindow;
      ...
      {
         var_1854 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1856 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1853 = initButton("room_invite",onInviteButtonClick,param1);
         var_1855 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _friendList.refreshButton(_loc3_,"start_chat",param2.online,method_9,param2.id);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1854,isEnableMinimailButton(_loc1_));
         setEnabled(var_1856,isEnableHomeButton(_loc1_));
         setEnabled(var_1853,isEnableInviteButton(_loc1_));
         setEnabled(var_1855,isEnableRemoveButton(_loc1_));
      }
