package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1265 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_683,var_1265);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_683,var_1469);
         }
         friendList.refreshText(param1,"name_text_offline",!var_683,var_1469);
         friendList.refreshText(param1,"motto_text",var_683,var_1862);
         friendList.refreshButton(param1,"offline",!var_683,null,0);
         if(var_683)
         {
            refreshFigure(param1,var_1863);
