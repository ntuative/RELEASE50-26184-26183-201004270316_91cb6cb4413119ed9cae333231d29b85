package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1425:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_331 && _loc4_.state != FriendRequest.const_344)
            {
      ...
      {
         var_1466 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1465 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1465.procedure = onDismissAllButtonClick;
         var_1466.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1005)
         {
