package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1054:PaletteManager;
      
      private var var_718:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_81:
               _loc3_ = var_233.getValue(AvatarType.const_81) as AvatarStructure;
               break;
            case AvatarType.PET:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_233.getValue(AvatarType.const_81) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_718 = new PetDataManager(_loc1_,_loc3_);
         var_1054 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_718.populateFigureData(_loc4_);
         ...
         var_233.add(AvatarType.const_81,_loc5_);
      ...
      {
         return var_718 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_743 = param1;
         if(var_743 == RenderMode.const_1273)
         {
            init();
         }
         if(var_743 == RenderMode.const_1354)
         {
            init();
      ...
      {
         var _loc5_:String = var_718.createAvatarFigureString(param1,param2,param3);
      ...
      {
         var _loc4_:AvatarStructure = var_233.getValue(AvatarType.const_81) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
