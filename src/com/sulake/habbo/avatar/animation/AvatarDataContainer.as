package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1556,var_1558,var_1555,_alphaMultiplier);
         var_1027 = generatePaletteMapForGrayscale(var_1939,var_1940);
      }
      
      public function get reds() : Array
      {
         return var_1027.getValue("reds") as Array;
      }
      ...
      {
         return var_1027.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1027.getValue("greens") as Array;
      }
      ...
      {
         return var_1027.getValue("alphas") as Array;
      }
