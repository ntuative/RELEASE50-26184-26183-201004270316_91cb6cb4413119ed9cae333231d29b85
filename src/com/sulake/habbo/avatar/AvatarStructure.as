package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1989:PartOffsetData;
      
      private var var_850:AvatarActionManager;
      
      private var var_178:IAssetLibrary;
      
      private var var_1039:IAssetLibrary;
      
      private var var_1990:AvatarRenderManager;
      ...
      private var var_1503:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_1503 = new AvatarStructureDownloadSet();
         var_708 = new AnimationManager();
         var_707 = param4;
         var_1989 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_850.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_850.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_850.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_708.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1201[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_850.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_708.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_707 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_707)
         {
            case AvatarType.const_81:
               ...
               var_1503.add(new AvatarStructureDownload(var_178,_loc5_,var_308));
               break;
            case AvatarType.PET:
         }
         var_1503.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_708.getAnimation(param1);
      }
      ...
      {
         var_850 = new AvatarActionManager(var_178,var_707);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1243 = var_308.getMandatorySetTypeIds();
         return var_1243;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1039.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1039.getAssetByName("dance" + _loc1_).content as XML;
            var_708.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1039.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1039.getAssetByName("fx" + _loc1_).content as XML;
            var_708.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_850.sortActions(param1);
      }
   }
}
