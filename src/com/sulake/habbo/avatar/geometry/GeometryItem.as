package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      public function GeometryItem(param1:XML, param2:Boolean = false)
      {
         ...
         var_1342 = parseFloat(param1.@radius);
         var_468 = new Vector3D(parseFloat(param1.@nx),parseFloat(param1.@ny),parseFloat(param1.@nz));
         var_1873 = parseInt(param1.@double) as Boolean;
         var_1872 = param2;
      }
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1342);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1342);
