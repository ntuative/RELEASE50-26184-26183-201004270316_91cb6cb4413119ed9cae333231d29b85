package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_799:AvatarEditorHandler;
      ...
      private const const_1046:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_658.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_166)
         {
            ...
            var_469["null"] = new FigureData(this);
            var_469["null"] = new FigureData(this);
            _loc1_ = var_469["null"];
            _loc2_ = var_469["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_91);
            var_90 = new Map();
            var_392 = new Map();
            var_90.add(AvatarEditorFigureCategory.const_809,new BodyModel(this));
            var_90.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            var_90.add(AvatarEditorFigureCategory.const_325,new TorsoModel(this));
            var_90.add(AvatarEditorFigureCategory.const_1215,new LegsModel(this));
            var_90.add(AvatarEditorFigureCategory.const_1291,new HotLooksModel(this));
            var_392.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_392.add(AvatarEditorSideCategory.const_473,new ClubPromoModel(this));
            var_166 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_981 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1421;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_981 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1046)
                  {
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1385.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1264)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_981 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1385.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_392.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_799 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_658.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_392.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_809);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_658 = var_561.getFigureData(AvatarType.const_81);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_981 = param3;
         var _loc4_:FigureData = var_469[param2];
         if(_loc4_ == null)
         {
            return;
         }
