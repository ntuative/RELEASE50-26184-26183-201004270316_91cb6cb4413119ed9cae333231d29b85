package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return var_27.sessionData.hasUserRight("fuse_use_wardrobe");
         }
         return var_27.sessionData.hasUserRight("fuse_larger_wardrobe");
      }
      ...
      private function init() : void
      {
         ...
         while(_loc1_ <= 10)
         {
            var_527.add(_loc1_,new WardrobeSlot(var_27,_loc1_,isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(_view)
         {
