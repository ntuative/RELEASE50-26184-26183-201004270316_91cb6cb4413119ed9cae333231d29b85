package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1638:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private const const_1637:int = 13421772;
      
      private var var_399:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1445 = Math.max(var_1445,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_899 + "_" + FigureData.const_267;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_399.width,var_399.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_899 + "_" + FigureData.const_267;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1444 && _loc2_.colorLayerIndex > 0)
               {
