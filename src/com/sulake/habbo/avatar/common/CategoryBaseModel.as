package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               if(_loc8_ && var_27 && false && _loc6_)
               {
                  var_27.figureData.savePartData(_loc5_,_loc8_.id,_loc6_.getSelectedColorIds(),true);
               }
               _loc3_ = true;
            }
            _loc4_++;
      ...
      public function selectPart(param1:String, param2:int) : void
      {
         ...
         if(var_27 && false)
         {
            var_27.figureData.savePartData(param1,_loc4_.id,_loc3_.getSelectedColorIds(),true);
         }
      }
      ...
      protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc3_:int = var_27.figureData.getPartSetId(param1);
         var _loc4_:Array = var_27.figureData.getColourIds(param1);
         if(!_loc4_)
         {
            _loc4_ = new Array();
         }
      ...
      protected function initCategory(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = var_27.generateDataContent(this,param1);
            if(_loc3_)
            {
