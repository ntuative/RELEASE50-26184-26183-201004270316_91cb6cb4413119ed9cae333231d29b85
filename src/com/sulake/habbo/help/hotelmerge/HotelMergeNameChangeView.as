package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1457:uint = 13232628;
      
      private static var var_1818:uint = 11129827;
      ...
      private var var_819:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_27.localization.registerParameter("help.tutorial.name.available","name",var_341);
         _loc1_.text = var_27.localization.getKey("help.tutorial.name.available");
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         return var_27.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function showSelectionView() : void
      {
         ...
         _window.caption = var_27.localization.getKey("hotel_merge.name_change.title.select");
      ...
      private function showConfirmationView() : void
      {
         ...
         _window.caption = var_27.localization.getKey("hotel_merge.name_change.title.confirm");
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               var_341 = var_27.myName;
               showConfirmationView();
               break;
            case "check_name_button":
               var_27.checkName(getName());
               nameCheckWaitBegin();
               break;
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1182 = _window.content.getChildAt(0) as IWindowContainer;
         }
         var_27.localization.registerParameter("hotel_merge.name_change.current","name",var_27.myName);
         _window.caption = var_27.localization.getKey("hotel_merge.name_change.title.main");
         showView(var_1182);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_945:
               var_27.localization.registerParameter("help.tutorial.name.taken","name",param2);
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.taken");
               break;
            case ChangeUserNameResultMessageEvent.var_944:
               var_27.localization.registerParameter("help.tutorial.name.invalid","name",param2);
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.invalid");
               break;
            case ChangeUserNameResultMessageEvent.var_943:
               break;
            case ChangeUserNameResultMessageEvent.var_948:
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_946:
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.short");
               break;
            case ChangeUserNameResultMessageEvent.var_1112:
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1113:
               _loc4_.text = var_27.localization.getKey("help.tutorial.name.merge_hotel_down");
         }
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1113 || param1 == ChangeUserNameResultMessageEvent.var_1112)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_819 = new NameSuggestionListRenderer(var_27);
         var _loc6_:int = var_819.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1457;
      ...
      public function setNormalView() : void
      {
         ...
         _loc1_.text = var_27.localization.getKey("help.tutorial.name.info");
      ...
      public function nameCheckWaitBegin() : void
      {
         ...
         if(_window && true)
         {
            ...
            if(_loc1_)
            {
               _loc1_.caption = var_27.localization.getKey("help.tutorial.name.wait_while_checking");
            }
         }
         var_820 = true;
      }
