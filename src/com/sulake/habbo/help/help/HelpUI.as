package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1441:int = 0;
      ...
      private var var_2108:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26184-26183-201004270241");
         var_200 = param5;
         var_105 = new Map();
         var_105.add(HabboHelpViewEnum.const_1385,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_150,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_478,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_201,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_699,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_302,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_732,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_217,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_105.add(HabboHelpViewEnum.const_808,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_681,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_273 == HabboHelpViewEnum.const_150 || false)
         {
            return;
         }
         if(var_437 == null)
         {
            ...
            var_437 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_437 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_437 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_437 as IWindow);
      ...
      {
         return var_105.getValue(var_273);
      }
      ...
      {
         var_2107 = param1;
         var _loc2_:IHelpViewController = var_105.getValue(HabboHelpViewEnum.const_150) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_217:
               ...
               break;
            case CallForHelpResultEnum.const_862:
               showUI(HabboHelpViewEnum.const_808);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_273 == HabboHelpViewEnum.const_150)
         {
            return;
         }
         if(true)
         {
            ...
            var_613.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_613.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_437.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_613[1],var_613[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_613[0],var_613[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1563;
         _window.width = _loc1_.width + var_1564;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_200 != null)
            {
               var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_383));
      }
