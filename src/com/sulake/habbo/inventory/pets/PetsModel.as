package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_27.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_27.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1161 && param1.type == RoomEngineObjectEvent.const_213)
         {
            var_27.showView();
            var_1161 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_27.roomSession.isRoomOwner)
         {
            var_1161 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_290,_loc3_.figure);
            var_27.closeView();
            return;
         }
         if(!var_27.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_983.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
