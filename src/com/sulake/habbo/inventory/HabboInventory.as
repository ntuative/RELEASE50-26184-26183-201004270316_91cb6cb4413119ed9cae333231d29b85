package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_813:IRoomSession;
      ...
      private const const_1639:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_407,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               var_813 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_407:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return FurniModel(var_47.getValue(InventoryCategory.const_76));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_978));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1639);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_313));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_814.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_814.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_47.getValue(InventoryCategory.const_314) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_268));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_407,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_314,_loc3_);
         ...
         var_47.add(InventoryCategory.const_313,_loc7_);
