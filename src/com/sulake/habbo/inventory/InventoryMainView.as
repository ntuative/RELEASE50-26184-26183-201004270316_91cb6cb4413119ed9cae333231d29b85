package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2349:IWindowContainer;
      ...
      public function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_63)
         {
            ...
            if(_loc3_ != var_758)
            {
               var_27.toggleInventoryPage(_loc3_);
            }
         }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_27.checkCategoryInitilization(param1);
         var _loc2_:ITabContextWindow = var_14.findChildByName("contentArea") as ITabContextWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.container.removeChild(var_1341);
         _loc2_.invalidate();
         var _loc3_:IWindowContainer = var_27.getCategoryWindowContainer(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_758 == InventoryCategory.const_139)
            {
               toggleCategoryView(InventoryCategory.const_139);
            }
            else if(var_758 == InventoryCategory.const_76)
            {
               toggleCategoryView(InventoryCategory.const_76);
            }
            else if(var_27 != null)
            {
               var_27.toggleInventoryPage(InventoryCategory.const_76);
            }
         }
      }
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_200 != null && var_912)
            {
               var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_200 != null)
         {
            var_200.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         var _loc3_:IWindowContainer = var_27.getCategorySubWindowContainer(param1);
         if(_loc3_ != null)
         {
            _loc2_.visible = true;
            _loc3_.visible = true;
         ...
         if(var_200 != null)
         {
            var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_639,HabboToolbarIconEnum.INVENTORY,var_14 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_200 != null && var_912)
         {
            var_200.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_912 = false;
         }
         var_27.inventoryViewOpened(var_757);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_758 || !var_27.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_200 != null && var_912)
            ...
            var_27.inventoryViewOpened(param1);
         }
      }
