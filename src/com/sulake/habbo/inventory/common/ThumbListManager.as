package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1022:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_588 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_588.width;
         var_94 = var_588.height;
         var_1021 = param5;
         var_839 = param6;
         var_227 = Math.floor(var_1021 / _thumbWidth);
         var_19 = new BitmapData(var_1021,var_839);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_19.height < var_839)
         {
            _loc12_ = new BitmapData(var_19.width,var_839);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_588.width,var_588.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_588.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_588,var_588.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1022 != null)
         {
            _loc1_ = var_1022.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_492 = resolveRowCountFromList();
         if(var_492 == 0)
         {
            var_19 = new BitmapData(var_1021,var_839);
            return;
         }
         var_19 = new BitmapData(Math.max(var_227 * _thumbWidth,var_1021),Math.max(var_492 * var_94,var_839),true,16777215);
         var_19.fillRect(var_19.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_492)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_227 && var_19.height < _loc3_.y * var_94)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_227 - 1),var_94);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_227 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_227 - 1),0 - var_94);
