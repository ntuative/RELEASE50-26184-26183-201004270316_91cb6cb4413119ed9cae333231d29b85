package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1394:uint = 9;
      
      public static const const_225:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_522 = false;
         var_739 = false;
         var_48.updateItemList(var_738);
         var_48.updateItemList(var_1306);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_48.alertPopup(TradingView.const_836);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_738)
            {
               var_522 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_738)
            {
               var_48.alertPopup(TradingView.const_991);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_34 + " NEW STATE: " + param1 + " OWN: " + var_522 + " OTHER: " + var_739);
         ...
         {
            case const_157:
               if(param1 == const_184 || param1 == const_225)
               {
                  var_34 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_609)
         {
            if(var_34 != const_157 && var_34 != const_225)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_157;
            var_11.toggleInventorySubPage(InventorySubCategory.const_846);
            var_609 = false;
         }
         var_48.setMinimized(false);
      }
