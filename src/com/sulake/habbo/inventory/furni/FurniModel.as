package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_543 = new Timer(const_1140,1);
      ...
      {
         return var_27.getSubCategoryViewId() == InventorySubCategory.const_273;
      }
      ...
      {
         return var_27.canUserOfferToTrade();
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_742)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_144 != null)
            {
               var_144.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_144.stop();
               var_144 = null;
            }
            if(var_766 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         {
            var_1107 = param1.ref;
            if(!var_27.recyclerModel.running)
            {
               requestClose();
            }
            var_924 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_766 == null)
         {
            var_766 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_766.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_27.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_27.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_273:
               ...
               break;
            case InventorySubCategory.const_846:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_144 = new Timer(param1,1);
            var_144.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_144.start();
         }
         else
         {
      ...
      {
         var_27.checkCategoryInitilization(InventoryCategory.const_314);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_76 && false)
         {
            ...
            {
               case const_45:
                  var_27.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_46:
                  var_27.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_319:
                  var_27.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc3_:RecyclerModel = var_27.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_924 && param1.type == RoomEngineObjectEvent.const_213)
         {
            var_27.showView();
            var_924 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_341 || _loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_305)
         {
            if(param1)
            {
               return false;
