package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_354 = param6;
         var_354.events.addEventListener(BadgeImageReadyEvent.const_124,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_825.length)
         {
            if(var_825[_loc2_] == param1)
            {
               var_825.splice(_loc2_,1);
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_354 != null)
            {
               var_354.events.removeEventListener(BadgeImageReadyEvent.const_124,onBadgeImageReady);
               var_354 = null;
            }
            _disposed = true;
         }
      ...
      {
         if(param1 == InventoryCategory.const_268 && false)
         {
            var_27.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
