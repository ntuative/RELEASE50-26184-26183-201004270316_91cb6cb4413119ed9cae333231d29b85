package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1638:int = 13421772;
      ...
      protected var var_2295:BitmapData;
      
      protected var var_949:Boolean;
      ...
      private const const_1637:int = 8947848;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_742)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1477));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1402);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1395 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2295;
               _loc5_.visible = true;
            }
            else
            {
