package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_729:OffenceCategoryData;
      ...
      private var var_728:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_877 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_879 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_878.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1293,var_435.text,getBanLength(),var_1294));
         this.dispose();
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1293,var_435.text,var_1294));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_729 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1293,var_435.text,var_1294));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_729 != null;
         if(this.var_728 != null)
         {
            var_51.findChildByName("offence_txt").caption = this.var_728.name;
            var_51.findChildByName("offence_category").visible = true;
         }
         else if(this.var_729 != null)
         {
            this.refreshButtons("offences_cont",2,var_729.offences,var_877,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_879,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_728 = var_729.offences[_loc3_];
         var_435.text = var_728.msg;
         var_314 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_51.caption = "Mod action on: " + var_1410;
         ...
         var_878 = IDropMenuWindow(var_51.findChildByName("banLengthSelect"));
         prepareBanSelect(var_878);
