package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_906 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_905 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1468);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_906.clone());
      ...
      {
         if(param1.type != WindowEvent.const_48 || param2 != var_51)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_905.clone());
         _loc4_.color = var_1331[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
