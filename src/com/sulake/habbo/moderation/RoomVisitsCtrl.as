package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2219:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2219.clone());
      ...
      {
         var_2219 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
