package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_937:String = "issue_bundle_open";
      
      public static const const_561:String = "issue_bundle_my";
      
      public static const const_944:String = "issue_bundle_picked";
      ...
      private var var_583:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_130 = new Map();
         var_832 = new Map();
         var_583 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_693 = [];
         var_833 = [];
         var_1016 = new Map();
      }
         ...
         for each(_loc4_ in var_130)
         {
            switch(param1)
            {
               case const_937:
                  ...
                  break;
               case const_561:
                  if(_loc4_.state == IssueMessageData.const_434 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_832.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_130)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_832.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_832.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_146)
         {
            ...
            _loc8_ = var_833.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_434 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_583 == null || !var_583.isOpen())
         {
            var_59.soundManager.playSound(HabboSoundTypesEnum.const_975);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_832.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_130.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_434 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
