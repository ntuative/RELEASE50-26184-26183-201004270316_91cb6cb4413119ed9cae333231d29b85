package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1280:ConversationView;
      
      private var var_14:IFrameWindow;
      
      private var var_430:Timer;
      
      private var var_772:ITextFieldWindow;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_772.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_772.text = "";
         var_137.conversations.addMessageAndUpdateView(new Message(Message.const_534,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_14 == null)
         {
            prepareContent();
            refresh(true);
            var_137.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MESSENGER,var_14));
         }
         else
         {
            refresh(true);
      ...
      private function prepareContent() : void
      {
         ...
         var_870 = new ConversationsTabView(var_137,var_14);
         var_870.refresh();
         var_772 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_772.addEventListener(WindowKeyboardEvent.const_149,onMessageInput);
         var_1280 = new ConversationView(var_137,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_546,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_1002,true);
      }
   }
}
