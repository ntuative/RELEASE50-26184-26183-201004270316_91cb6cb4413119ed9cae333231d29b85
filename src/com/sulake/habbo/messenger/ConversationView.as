package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_2233:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_137 = param1;
         var_1597 = initButton("follow_friend",onFollowButtonClick,param2);
         var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2233 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_534 || param3.type == Message.const_667 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_540.messages.length - const_794);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_540.messages.length)
         {
            refreshEntry(true,_loc1_,var_540.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_540 == null || _loc1_.id != var_540.id)
         {
            var_540 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_794 + const_1136)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_137.send(new FollowFriendMessageComposer(var_540.id));
      }
