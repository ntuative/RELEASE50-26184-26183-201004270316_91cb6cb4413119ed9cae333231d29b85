package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1150 || var_1511 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1510 == 0 || _loc1_ - var_1510 > var_1511)
         {
            if(_connection != null)
            {
      ...
      {
         var_1150 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1511 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
