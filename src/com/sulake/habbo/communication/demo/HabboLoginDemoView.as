package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_241:HabboCommunicationDemo;
      ...
      {
         var_241.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_241.shockwaveClientUrl = var_120.shockwaveClientUrl;
         var_241.ssoTicket = var_120.ticket;
         var_120.removeEventListener(SSOTicket.const_303,onParsedTicketSuccess);
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1430,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_241 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_241.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_431,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_241.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1430,"/");
         if(_loc5_ != null)
         {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_241.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_241.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_241.habboCommunication.habboWebLogin(name,password);
         var_120 = new SSOTicket(var_241.assets,_loc2_,_loc1_);
         var_120.addEventListener(SSOTicket.const_303,onParsedTicketSuccess);
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_241.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_241.windowManager.buildFromXML(_loc3_.content as XML);
