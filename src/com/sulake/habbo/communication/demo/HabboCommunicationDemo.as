package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1973:PseudoRandom;
      ...
      private const const_1430:String = "fuselogin";
      
      private var var_318:ICoreCommunicationManager;
      
      private var var_418:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1279:
            case DisconnectReasonEvent.const_1169:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1212:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1231:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1974)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_701 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_701);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1229,var_1972));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1430,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_418.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_418.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1973);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1430,"/");
      ...
      {
         var_701 = _habboConfiguration.getKey("sso.ticket",null);
         var_1229 = _habboConfiguration.getKey("flash.client.url","");
         var_1972 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_177 == null)
         {
         ...
         if(var_701 != null)
         {
            var_60.mode = HabboConnectionType.const_401;
            var_60.initConnection(HabboConnectionType.const_245);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_743);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1973 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_401:
               _loc6_ = "";
               ...
               var_1032 = _loc4_;
               var_177.loadBannerImage(_loc7_ + "?token=" + var_1032,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_921:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1361:
               var_591 = generateRandomHexString(30);
               var_418 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_418.init(var_591);
               _loc8_ = var_418.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1032);
         ...
         var_418 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_418.init(_loc14_);
            _loc15_ = var_418.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_60.mode = HabboConnectionType.const_921;
            }
         }
         var_60.initConnection(HabboConnectionType.const_245);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_183,onConfigurationLoaded);
         }
      }
