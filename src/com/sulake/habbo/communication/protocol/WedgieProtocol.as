package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1324:uint = 1;
      
      public static const const_1343:uint = 2;
       
      
      private var var_941:IProtocolDecoder;
      
      private var var_1111:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1111 = new WedgieEncoder();
         var_941 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1324)
            {
               _loc4_.position = 0;
               _loc6_ = var_941.getID(_loc4_);
