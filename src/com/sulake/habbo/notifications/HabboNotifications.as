package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1100:String = "pet_inventory";
      
      private static const const_1106:String = "pixelbalance";
      
      private static const const_1104:String = "credits";
      
      private static const const_1102:String = "inventory";
      ...
      private var var_607:ParkBusDialogManager;
      
      private var var_606:IHabboToolbar;
      ...
      private var var_724:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_871);
         }
         var _loc6_:Map = var_871["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1211);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_724 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_885)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_606)
         {
            var_606.release(new IIDHabboToolbar());
            var_606 = null;
         }
         if(_windowManager)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2063)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_852);
            var_2063 = true;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_852,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_561.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_854,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_172 || param2.type == WindowEvent.const_685)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_607 == null)
         {
            var_607 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_607 != null)
         {
            var_607.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1055.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_561.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_354.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc9_ = var_354.getWallItemData(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1373,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_561.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1184)
         {
      ...
      {
         var_606 = IHabboToolbar(param2);
         var_606.events.addEventListener(HabboToolbarEvent.const_93,onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_93)
         {
            ...
            var_431 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_871["styles"],var_871["view"],var_606);
            ...
            var_354.events.addEventListener(BadgeImageReadyEvent.const_124,onBadgeImage);
            var_606.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
