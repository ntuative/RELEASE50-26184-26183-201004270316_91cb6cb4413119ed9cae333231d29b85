package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1992 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1993 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_709 = new Timer(1000,1);
         var_709.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_114,onInputChanged);
         _window.addEventListener(WindowEvent.const_388,onWindowMoved);
         var_1244 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1991 = _loc2_.width + const_495 + _loc6_.width + const_1087;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1088,_loc8_.width) + const_495);
            _loc8_.x = _loc12_;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_498);
