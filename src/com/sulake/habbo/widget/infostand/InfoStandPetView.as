package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1645:uint = 6710886;
      ...
      private const const_1648:String = "nutrition";
      ...
      private var var_170:PetCommandTool;
      
      private const const_1649:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_222 != null)
         {
            var_103 = var_222.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_103 == null || var_222 == null || var_62 == null)
         {
            return;
         }
         ...
         var_222.height = NaN;
         _window.width = Math.max(var_222.width,var_62.width);
      ...
      private function openTrainView() : void
      {
         if(var_170 == null)
         {
            var_170 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1180.getValue(var_596) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_170.showWindow(true);
            var_170.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1648,param1.nutrition,param1.nutritionMax);
         ...
         if(var_170 && var_170.isVisible() && param1.isOwnPet)
         {
            var_170.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_170.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_170 && var_170.getPetId() == var_596)
               {
                  var_170.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_421,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1644,const_1642,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1649);
         ...
         _loc5_.fillRect(_loc7_,const_1645);
         return _loc5_;
      }
