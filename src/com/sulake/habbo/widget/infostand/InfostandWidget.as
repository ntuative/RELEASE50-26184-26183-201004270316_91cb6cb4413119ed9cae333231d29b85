package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1435:String = "infostand_user_view";
      ...
      private const const_1438:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1436:String = "infostand_pet_view";
      
      private const const_1437:String = "infostand_furni_view";
      
      private const const_1658:int = 3000;
      
      private var var_204:InfoStandUserView;
      
      private var var_404:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_874 = new InfoStandFurniView(this,const_1437);
         var_204 = new InfoStandUserView(this,const_1435);
         var_311 = new InfoStandPetView(this,const_1436);
         var_356 = new InfoStandBotView(this,const_1438);
         var_404 = new InfostandUserData();
         var_454 = new InfostandFurniData();
         var_1180 = new InfoStandPetData();
         var_138 = new Timer(const_1658);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_204.setTags(param1.tags,var_2075);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_544,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_744,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_409,var_311.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_544,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_744,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_266:
               ...
               {
                  _loc2_ = param1.id == var_404.userRoomId;
                  break;
               }
