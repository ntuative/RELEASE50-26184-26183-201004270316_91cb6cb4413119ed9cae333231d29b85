package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_246.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_246.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_61,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1040,const_1039,2,2),null,0) as IWindowContainer;
         ...
         var_246 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_246.numTabItems)
         {
            _loc6_ = var_246.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_246.selector.getSelected();
         return var_246.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1102 = _loc2_.light;
         if(var_375 != null)
         {
            var_375.setValue(var_1102);
         }
         var_386 = colors.indexOf(_loc2_.color);
         if(var_539 != null)
         {
            var_539.setSelectedColorIndex(var_386);
         }
