package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.addEventListener(WindowEvent.const_257,onChildResized);
      ...
      public function dispose() : void
      {
         if(_widget && false)
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_651));
         }
         _widget = null;
         if(false)
         {
