   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_895 = _window.findChildByName("effect_hilite");
            var_895.visible = false;
         }
         var_893 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_894 = _window.findChildByName("loader_bar");
         if(var_894 != null)
         {
            var_402 = var_894.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_893 != null)
         {
            var_893.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_893.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
