package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1063:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_1007,var_1008,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1007,var_681,var_1008,_roomId,_roomCategory,param1);
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1193)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_105:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_244:
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1006 != 0)
            {
               _loc30_ = uint(var_1006 >> 16 & 255);
               _loc31_ = uint(var_1006 >> 8 & 255);
               _loc32_ = uint(var_1006 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1193 == RoomWidgetChatUpdateEvent.const_244)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_681);
            }
            else if(var_1193 == RoomWidgetChatUpdateEvent.const_240)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_681);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_350 + _loc20_.textWidth + const_495;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1007,var_1008,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1007,var_1008,_roomId,_roomCategory,param1);
      }
