package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_769:int = 4000;
      ...
      private static const const_502:int = 8;
      
      private static const const_352:int = 0;
      
      private static const const_501:int = (const_502 + const_352) * const_102 + const_102;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_228 = new Array();
         var_697 = new Point();
         var_154 = const_501 + const_283;
         super(param1,param2,param3);
         var_1932 = param5;
         var_38 = param1.createWindow("chat_container","",HabboWindowType.const_61,HabboWindowStyle.const_43,HabboWindowParam.const_42,new Rectangle(0,0,200,var_154 + RoomChatHistoryPulldown.const_78),null,0) as IWindowContainer;
         var_38.background = true;
         var_38.color = 33554431;
         var_38.tags.push("room_widget_chat");
         var_346 = param1.createWindow("chat_contentlist","",HabboWindowType.const_904,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,200,var_154),null,0) as IItemListWindow;
         var_38.addChild(var_346);
         var_134 = param1.createWindow("chat_active_content","",HabboWindowType.const_61,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,200,var_154),null,0) as IWindowContainer;
         var_346.addListItem(var_134);
         var_26 = new RoomChatHistoryViewer(this,param1,var_38,param2);
         var_1931 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_567,onChatMessage);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_154 = const_501 + const_283;
         var_38.height = var_154 + var_26.pulldownBarHeight;
         var_346.width = 0 - 0;
         var_346.height = var_154;
         var_134.width = 0 - 0;
         if(historyViewerActive())
         {
            var_134.height = getTotalContentHeight() + const_283;
         }
         else
         {
            var_134.height = var_154;
         }
         var_346.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      private function processBuffer() : void
      {
         ...
         while(var_65.length > const_1080 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_696 = getTimer() + const_769;
         }
         else
         {
            if(false && false)
            {
               var_589 = getItemSpacing(_itemList["-1"],var_65[0]);
            }
            else
            {
               var_589 = const_102;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_697.x) * var_841;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_770;
         var _loc6_:Number = 0 + const_770 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1222 && !historyViewerActive())
         {
            resetArea();
            var_1222 = false;
         }
      ...
      {
         return "chat_" + var_1932.toString() + "_item_" + (var_1930++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_567,onChatMessage);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_434)
         {
            _loc2_ = param1 / const_1062 * const_1079;
            if(_loc2_ + var_698 > var_589)
            {
               _loc2_ = var_589 - var_698;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1485 == 0)
            {
               var_1485 = param1.scale;
            }
            else
            {
               var_841 = param1.scale / var_1485;
            }
         }
         if(param1.positionDelta != null)
         {
            var_697.x += param1.positionDelta.x / var_841;
            var_697.y += param1.positionDelta.y / var_841;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1931)
         {
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_502 + const_352 + 2)
               {
                  _loc1_.aboveLevels = const_502 + const_352 + 2;
               }
               var_493 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_154 = param1 - 0;
         var_38.height = var_154 + RoomChatHistoryPulldown.const_78;
         if(var_26 != null)
         {
            var_26.containerResized(var_38.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_720,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_352 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1078)
               {
