package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_747[var_1086] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_319)
         {
            ...
            var_319 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_319.center();
            var_319.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1086;
         if(var_1086 < var_747.length)
         {
            _loc1_ = var_747[var_1086] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_747.length);
                  _loc2_.text = _loc6_;
               }
