package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2111:Number = -10000000;
      
      private var var_2109:Number = -10000000;
      
      private var var_2371:int = 0;
      
      private var var_511:RoomObjectCache;
      
      private var var_731:int;
      
      private var var_274:Sprite;
      
      private var var_1065:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1064 == 0)
         {
            checkMouseHits(var_1066.x,var_1066.y,MouseEvent.MOUSE_MOVE);
         }
         var_1064 = 0;
         ++var_1565;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2371);
      ...
      {
         var _loc11_:Number = param1 - var_731 / 2;
         var _loc12_:Number = param2 - var_732 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_731 != var_2112 || var_732 != var_2113)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_438.sortOn("z",0 | 0);
         if(_loc6_ < var_438.length)
         {
            var_438.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_438[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_884.push(_loc12_ - _loc2_);
         if(var_884.length == const_776)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_776)
            {
               _loc13_ += var_884[_loc14_];
               _loc14_++;
            }
            var_884 = [];
         }
         ...
         while(_loc1_ < var_316.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1065 != null)
                  {
                     var_1065.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1565,geometry);
                  }
                  else
                  {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return var_438[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2111 || param2 != var_2109)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_511.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_511.getObjectCache(param2);
         ...
         _loc13_ += int(var_731 / 2);
         _loc14_ += int(var_732 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_731 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_732))
                  {
