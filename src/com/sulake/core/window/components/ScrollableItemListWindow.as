package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_824:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_343)
         {
            ...
            if(var_343)
            {
               var_343.addEventListener(WindowEvent.const_276,scrollBarEventProc);
               var_343.addEventListener(WindowEvent.const_228,scrollBarEventProc);
            }
         }
         return var_343;
      }
      ...
      override public function dispose() : void
      {
         if(var_343)
         {
            var_343.removeEventListener(WindowEvent.const_276,scrollBarEventProc);
            var_343.removeEventListener(WindowEvent.const_228,scrollBarEventProc);
            var_343 = null;
         }
         if(var_824)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_824)
         {
            var_824 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_824;
      }
