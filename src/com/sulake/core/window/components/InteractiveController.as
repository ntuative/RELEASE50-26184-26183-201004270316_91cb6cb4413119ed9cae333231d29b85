package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1413:uint = 500;
      ...
      protected var var_2301:uint = 0;
      
      protected var var_951:String = "";
      
      protected var var_459:Array;
      
      protected var var_952:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_459 = new Array();
         var_459[0] = MouseCursorType.const_328;
         var_459[1] = MouseCursorType.const_43;
         var_459[2] = MouseCursorType.const_328;
         var_459[3] = MouseCursorType.const_328;
         var_459[4] = MouseCursorType.const_43;
         var_459[5] = MouseCursorType.const_43;
         var_459[6] = MouseCursorType.const_328;
         if(var_334 == null)
         {
            var_334 = new Array();
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_968,param1.toolTipDelay != const_1413));
         return param2;
      }
      ...
      {
         var_951 = param1 == null ? const_747 : param1;
      }
