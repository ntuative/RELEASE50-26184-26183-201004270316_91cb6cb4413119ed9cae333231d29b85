package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_88 = 0;
         var_67 = 0;
         _horizontal = param2 == WindowType.const_333;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_164 = var_641 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_287,WindowStyle.const_299,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_257,containerEventHandler);
      ...
      {
         return new Rectangle(var_551 * maxScrollH,var_550 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_257,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1032,var_776,PropertyStruct.const_60,var_776 != const_1409));
         _loc1_.push(new PropertyStruct(const_1033,var_549,PropertyStruct.const_60,var_549 != const_1408));
         _loc1_.push(new PropertyStruct(const_1030,var_1117,PropertyStruct.const_60,var_1117 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_452,param1);
            }
            else
            {
