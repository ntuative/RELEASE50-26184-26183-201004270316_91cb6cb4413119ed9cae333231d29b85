package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1074:String = "content";
      
      private static const const_1075:String = "selector";
       
      
      private var var_1173:Boolean = false;
      
      protected var var_950:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1617 == null)
         {
            var_1617 = findChildByTag(TabContextController.const_1074) as IWindowContainer;
         }
         return var_1617;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_950 == null)
         {
            var_950 = findChildByTag(TabContextController.const_1075) as ITabSelectorWindow;
            if(var_950 != null)
            {
               var_950.procedure = selectorEventProc;
            }
         }
         return var_950;
      }
      ...
      {
         return !!var_843 ? selector.iterator : null;
      }
