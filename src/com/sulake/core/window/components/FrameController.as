package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1128:String = "_HEADER";
      
      private static const const_781:String = "margin_right";
      
      private static const const_1127:String = "_SCALER";
      
      private static const const_1064:String = "_TITLE";
      
      private static const const_1129:String = "_CONTENT";
      
      private static const const_782:String = "margin_left";
      ...
      private var var_1334:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_782,_loc3_.left,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_783,_loc3_.top,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_781,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_784,0 - _loc3_.bottom,PropertyStruct.const_69,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1334 == null)
         {
            var_1334 = findChildByTag(const_1128) as IHeaderWindow;
            if(!var_1334)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1064) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1127) as IScalerWindow;
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1129) as IWindowContainer;
            if(!var_20)
            {
