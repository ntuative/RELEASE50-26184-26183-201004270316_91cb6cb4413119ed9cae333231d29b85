package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_750:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1672 = new Dictionary();
         TypeCodeTable.fillTables(var_1422,var_1672);
         var_1156 = new Dictionary();
         var_1671 = new Dictionary();
         StateCodeTable.fillTables(var_1156,var_1671);
         var_470 = new Dictionary();
         var_470["skin"] = BitmapSkinRenderer;
         var_470["bitmap"] = BitmapDataRenderer;
         var_470["fill"] = FillSkinRenderer;
         var_470["text"] = TextSkinRenderer;
         var_470["shape"] = ShapeSkinRenderer;
         var_470["unknown"] = SkinRenderer;
         var_470["null"] = NullSkinRenderer;
         if(var_384 == null)
         {
            var_384 = new Array();
            var_384.push(WindowState.const_68);
            ...
            var_384.push(WindowState.const_92);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1156)
         {
            _loc3_.push(var_1156[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1422[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_660[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_659[param1] = new Array(SkinContainer.const_750);
         }
         var_659[param1][param2] = param3;
         if(true)
         {
            var_660[param1] = new Array(SkinContainer.const_750);
         }
         var_660[param1][param2] = param4;
      }
