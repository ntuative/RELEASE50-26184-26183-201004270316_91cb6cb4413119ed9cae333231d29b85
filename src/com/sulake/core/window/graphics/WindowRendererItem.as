package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_390:
               ...
               break;
            case WindowRedrawFlag.const_812:
               var_672 = var_671.getTheActualState(param1.type,param1.style,param1.state);
               if(var_672 != var_990)
               {
                  var_220 = true;
                  _loc4_ = true;
      ...
      {
         return var_671.getTheActualState(param1.type,param1.style,param1.state) != var_990;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_754) : uint(const_494);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_672))
            {
               _loc5_ = const_755;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_755)
               {
                  ...
                  if(var_220)
                  {
                     ...
                     _loc7_.draw(param1,var_93,var_93.rect,var_672,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_35))
                  {
                     ...
                     _loc4_.draw(var_93,var_955,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_671.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_997)
            {
               _loc2_ = var_671.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_997);
            }
         }
         return _loc2_;
      }
