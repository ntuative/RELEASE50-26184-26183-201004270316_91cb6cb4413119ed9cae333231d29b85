package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1619:String = "_INCLUDE";
      
      public static const const_833:String = "_EXCLUDE";
      
      public static const const_1560:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_958,var_1400);
         var_1401 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1400)
            {
               delete var_1400[_loc1_];
            }
            var_1401.dispose();
            var_1401 = null;
            var_16 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_833) == -1)
                  {
