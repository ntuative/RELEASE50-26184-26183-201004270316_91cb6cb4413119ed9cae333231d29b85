package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1122:String = "zip-libraries";
      ...
      private var var_322:uint;
      
      private var var_1089:IEventDispatcher;
      
      private var var_902:Profiler;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_1399 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_529 = new Array();
         var_622 = new Array();
         var_213 = param1;
         var _loc3_:int = 0;
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_822:
               ...
               break;
            case Core.const_1185:
               debug("Core; using profiler frame update handler");
               var_213.addEventListener(Event.ENTER_FRAME,profilerFrameUpdateHandler);
               var_902 = new Profiler(this);
               attachComponent(var_902,[new IIDProfiler()]);
               var_750 = new ProfilerViewer();
               var_213.addChild(var_750);
               break;
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_1089)
         {
            ...
            var_1089.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,param1.bytesLoaded,param1.bytesTotal));
         }
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return var_322 - getNumberOfFilesPending();
      }
         ...
         while(criticality < CoreComponent.const_138)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_902.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_1089)
         {
            var_1089.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         {
            error("Failed to parse zip libraries from config xml!",true,Core.const_173,e);
         }
         if(var_282 == null)
         {
            var_282 = new Array();
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_173,e);
         }
         if(var_285 == null)
         {
            var_285 = new Array();
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_173,e);
         }
         if(var_281 == null)
         {
            var_281 = new Array();
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_173,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1252);
         if(!_isDisposed)
         {
