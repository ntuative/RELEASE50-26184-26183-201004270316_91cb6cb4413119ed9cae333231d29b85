   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_751)
            {
               if(var_667 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_667.errorID,var_667);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_667);
               }
            }
      ...
      public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         if(!_loc6_)
         {
            ...
            _eventDispatcher.addEventListener(param1,method_8);
         }
         else
         {
      ...
      private function method_8(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1047) : uint(const_493);
      }
