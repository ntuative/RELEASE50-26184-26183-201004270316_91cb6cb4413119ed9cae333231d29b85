package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_957:LoaderContext;
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         _type = param1;
         var_15 = new Loader();
         var_957 = new LoaderContext();
         var_957.checkPolicyFile = true;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_383 < var_2363)
            {
               ...
               var_15.load(new URLRequest(var_645 + (var_645.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_383),var_957);
               return true;
            }
         }
         return false;
